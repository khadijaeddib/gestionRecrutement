...
@Component({
  selector: 'app-admin-show-interview',
  templateUrl: './admin-show-interview.component.html',
  styleUrls: ['./admin-show-interview.component.css']
})
export class AdminShowInterviewComponent implements OnInit {
